function [post_mean, post_var, lap_approx, true_int] ...
    = laplace_poc(f, a, b, d, s, lambda, alpha, input_true_int, make_plots)
...
if input_true_int
    ...
    % domain.
    if a > -Inf && b < Inf
        bounds= [repelem(a, d)*rot_scale_mat + mode;...
        ...
        input_prompt = [input_prompt newline "We've also taken the liberty "...
            ...
            "vectors lower_bounds and upper_bounds." newline...
            "Make sure they're not on the GPU for symbolic/vpa integration."];
    end
